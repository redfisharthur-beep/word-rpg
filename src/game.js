...
function nextQuestion(){if(run.q>=10){run.question=makeQuestion();screen='play';render();return}run.q++;run.question=makeQuestion();run.enemy=freshEnemy(run.q);screen='play';render();}
