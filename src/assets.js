...
function installSetupAssetStyles(){
  ...
  style.textContent=`.setup-card{grid-template-columns:repeat(3,minmax(0,1fr))!important;column-gap:14px!important}.setup-card>.choice-section{grid-column:1/-1}.setup-actions,.progression-actions{display:contents!important}.setup-actions>button,.progression-actions>.progression-btn{width:100%!important;height:112px!important;min-height:112px!important;padding:0!important;border:0!important;background-color:transparent!important;overflow:hidden;align-self:stretch}.setup-actions>button img{display:block!important;width:100%!important;height:100%!important;max-width:100%!important;max-height:100%!important;object-fit:contain!important}.progression-btn{background-position:center!important;background-repeat:no-repeat!important;background-size:contain!important}.progression-btn>*{opacity:0!important;pointer-events:none!important}.setup-actions>[data-action="start"]{order:10}.setup-actions>[data-action="pk"]{order:11}.tower-entry{order:12;background-image:url('${ASSETS.ui.tower}')!important}.setup-actions>[data-action="pet-tree"]{order:13}.setup-actions>[data-action="equipment"]{order:14}.collection-entry{order:15;background-image:url('${ASSETS.ui.collection}')!important}@media(max-width:700px){.setup-card{column-gap:8px!important}.setup-actions>button,.progression-actions>.progression-btn{height:92px!important;min-height:92px!important}}`;
  document.head.appendChild(style);
}
